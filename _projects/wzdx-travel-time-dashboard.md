...
<div class="project-video-container" style="text-align: center; margin: 2rem 0;">
  <video autoplay loop muted playsinline style="max-width: 100%; border-radius: 8px; border: 1px solid var(--card-border); box-shadow: 0 4px 20px rgba(0,0,0,0.15);">
    <source src="{{ '/assets/images/0-7034_Web_App_Video.mp4' | relative_url }}" type="video/mp4">
